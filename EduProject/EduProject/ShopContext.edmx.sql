...
-- --------------------------------------------------
-- Date Created: 09/23/2016 17:59:31
-- Generated from EDMX file: F:\MySpace\biyesheji\EduProject\EduProject\ShopContext.edmx
-- --------------------------------------------------
...
-- Creating primary key on [Product_ProductId], [Order_OrderId] in table 'ProductOrder'
ALTER TABLE [dbo].[ProductOrder]
ADD CONSTRAINT [PK_ProductOrder]
    PRIMARY KEY CLUSTERED ([Product_ProductId], [Order_OrderId] ASC);
GO
